...
# ---------------- callback functions
log_dir = join(abspath(join(dirname(__file__),pardir)),'models/CartPole/A2C')
...
if TRAINING_MODE == True:
    ...
    # ---------------- prediction
    print('Prediction')
    model_dir = join(abspath(join(dirname(__file__),pardir)),'models/CartPole/A2C/best_model')

...
# ---------------- callback functions
log_dir = join(abspath(join(dirname(__file__),pardir)),'models/CartPole/PPO')
...
if TRAINING_MODE == True:
    ...
    # ---------------- prediction
    print('Prediction')
    model_dir = join(abspath(join(dirname(__file__),pardir)),'models/CartPole/PPO/best_model')
